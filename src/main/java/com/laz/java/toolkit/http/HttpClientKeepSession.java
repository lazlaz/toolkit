package com.laz.java.toolkit.http;
...
public class HttpClientKeepSession {
	private static final Logger LOG = LoggerFactory.getLogger(HttpClientKeepSession.class);
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		//用户登陆
		CloseableHttpResponse response = HttpClientKeepSession.post("http://192.168.5.7:7777/DCHCC/data/Login.svt", "username=zdc&password=000518f1970096463381db71e6db");
		
		printResponse(response);
		printCookies();
//		addCookie("username","zdc","http://192.168.5.7:7777","/DCHCC/");
//		addCookie("password","100200","http://192.168.5.7:7777","/DCHCC/");
		
		//上传数据
		HttpClientKeepSession.upload("http://192.168.5.7:7777/DCHCC/data/uploadfile.svt?upload=upload&saveType=1&filePath=FileConfig.jarAddr");			
		printCookies();
